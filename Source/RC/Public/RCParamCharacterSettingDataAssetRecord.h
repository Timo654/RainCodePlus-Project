...
#include "RCParamCharacterSettingDataAssetRecord.generated.h"

USTRUCT(BlueprintType)
struct FRCParamCharacterSettingDataAssetRecord {
    GENERATED_BODY()
public:
    ...
    RC_API FRCParamCharacterSettingDataAssetRecord();
};
